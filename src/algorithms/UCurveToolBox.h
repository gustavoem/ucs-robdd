...
namespace UCurveToolBox
{
	...
	//
	ElementSubset * get_maximal_subset (Collection *, Collection *, ElementSet *);
	...
	//
	ElementSubset * get_minimal_subset (Collection *, Collection *, ElementSet *);
	...
	//
	void DFS
	     (Node *, Collection *, Collection *, Collection *, CostFunction *, unsigned int *);
	...
	Node * select_an_unvisited_adjacent
	       (map<string, Node *> *, Collection *, Collection *, Node *, unsigned int *);
