...
void CostFunction::set_max_number_of_calls_of_cost_function (unsigned int max_number_of_calls)
{
...
unsigned int CostFunction::get_number_of_visited_nodes_during_branch_and_bound ()
{
	return number_of_visited_nodes_during_branch_and_bound;
}
...
void CostFunction::set_number_of_visited_nodes_during_branch_and_bound (unsigned int x)
{
	number_of_visited_nodes_during_branch_and_bound = x;
}
