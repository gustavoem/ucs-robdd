...
protected:
	...
	// Returns the MCE of a given subset X.
	//
	float calculate_MCE (ElementSubset *);

	// Computes the distribution of a subset X from W-operator samples,
	...
	// Returns the conditional entropy of Y given X=x;
	// the distribution of the samples must be computed before using this function.
	//
