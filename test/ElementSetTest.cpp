...
namespace ElementSetTest
{
	...
	bool an_empty_set_should_not_have_elements ()
	{
		...
		ElementSet set3 ("S3", "input/ElementSetTestEmptyFile.xml");
	...
	{
		ElementSet set ("S1", "input/ElementSetTest3ElementsFile.xml");
	...
	{
		ElementSet set ("input/ElementSetTest01.dat", 7);
	...
	bool values_from_a_random_set_should_be_within_the_given_range ()
	{
		...
		if (count_zeros > 1000)
			cout << "\nWarning: too many zeros in ElementSet() : " << count_zeros << "!" << endl;
		return true;
	}
