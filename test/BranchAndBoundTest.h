//
// BranchAndBoundTest.h -- definition of the namespace "BranchAndBoundTest".
//
...
#ifndef BRANCH_AND_BOUND_TEST_H_
#define BRANCH_AND_BOUND_TEST_H_

#include "../src/algorithms/BranchAndBound.h"
...
#endif /* BRANCH_AND_BOUND_TEST_H_ */
