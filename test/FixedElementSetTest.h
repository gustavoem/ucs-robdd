//
// FixedElementSetTest.h -- definition of the namespace "FixedElementSetTest".
//
...
#ifndef FIXEDELEMENTSETTEST_H_
#define FIXEDELEMENTSETTEST_H_

#include "../src/FixedElementSet.h"
